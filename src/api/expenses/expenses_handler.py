...
class ExpenseHandler:
    ...
    def get_expenses(
        ...
        return self.expenses_manager.get_expenses(
            user_id=user.id,
            session=session
        )
    ...
    def get_expenses_excel_report(
        ...
        return Response(content=expenses_report, media_type="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", headers=headers)
    ...
    def delete_expense(
        ...
        self.expenses_manager.delete_expense(
            expense_id=expense_id,
            session=session
        )